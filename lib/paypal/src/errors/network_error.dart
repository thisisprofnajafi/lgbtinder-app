...
class NetworkError extends StatelessWidget {
  ...
  const NetworkError({required this.loadData, required this.message, this.isSmall = false});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text("$message",
                  style: TextStyle(fontSize: 14, color: Color(0xFF272727), fontWeight: FontWeight.w400)),
              SizedBox(
                width: 5,
              ),
              InkWell(
