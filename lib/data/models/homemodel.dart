...
class HomeModel {
  ...
  factory HomeModel.fromJson(Map<String, dynamic> json) => HomeModel(
        ...
        profilelist: json["profilelist"] == null
            ? []
            : List<Profilelist>.from(json["profilelist"]!.map((x) => Profilelist.fromJson(x))),
        currency: json["currency"],
        totalliked: json["totalliked"] == null
            ? []
            : List<Profilelist>.from(json["totalliked"]!.map((x) => Profilelist.fromJson(x))),
        directChat: json["direct_chat"],
        likeMenu: json["Like_menu"],
        audioVideo: json["audio_video"],
        filterInclude: json["filter_include"],
