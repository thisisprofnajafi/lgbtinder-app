...
class Profileinfo {
  ...
  factory Profileinfo.fromJson(Map<String, dynamic> json) => Profileinfo(
        ...
        profileDistance: json["profile_distance"],
        profileImages:
            json["profile_images"] == null ? [] : List<String>.from(json["profile_images"]!.map((x) => x)),
        matchRatio: json["match_ratio"]?.toDouble(),
        ...
        interestList: json["interest_list"] == null
            ? []
            : List<InterestListElement>.from(json["interest_list"]!.map((x) => InterestListElement.fromJson(x))),
        languageList: json["language_list"] == null
            ? []
            : List<InterestListElement>.from(json["language_list"]!.map((x) => InterestListElement.fromJson(x))),
      );
