...
class ChattingPage extends StatefulWidget {
  ...
  final String proPic;
  const ChattingPage({super.key, required this.resiverUserId, required this.resiverUseremail, required this.proPic});
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          chattingProvider.isLoading ? CircularProgressIndicator(color: AppColors.appColor) : const SizedBox(),
        ],
      ),
    );
  }
      ...
      title: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.active) {
              ...
              print(data.isEmpty);
              return BlocBuilder<HomePageCubit, HomePageStates>(builder: (context1, state) {
                      ...
                      InkWell(
                                ...
                                _firebaseStorage
                                  ...
                                  chattingProvider
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              AudioCallingScreen(userData: data, channel: vcRoomId),
                                        ));
                                  });
                          ...
                          child: SvgPicture.asset(
                            ...
                            colorFilter: ColorFilter.mode(
                                homeProvider.userlocalData.userLogin!.planId == "1"
                                    ? Theme.of(context).indicatorColor.withOpacity(0.2)
                                    : homeProvider.userlocalData.userLogin!.planId == "2"
                                        ? Theme.of(context).indicatorColor.withOpacity(0.2)
                                  ...
                                  if (value.data()!["isVc"] == true) {
                                    chattingProvider
                                      ...
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => VideoCall(channel: vcRoomId),
                                          ));
                                    });
                                  }
                                });
                                  ...
                                  Column(children: [
                                    InkWell(
                                            ...
                                            title: Column(
                                              children: [
                                                SizedBox(
                                                  ...
                                                  width: 200,
                                                  child:
                                                      Lottie.asset('assets/lottie/block.json', fit: BoxFit.cover),
                                                ),
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      AppLocalizations.of(context)?.translate("Blocking") ??
                                                          "Blocking",
                                                      ...
                                                      child: ElevatedButton(
                                                        onPressed: () {
                                                          ...
                                                          detailProvider.profileblockApi(
                                                              context: context,
                                                              profileblock: widget.resiverUserId);
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          const Image(
                                              image: AssetImage("assets/icons/block.png"), height: 20, width: 20),
                                          const SizedBox(
                                            width: 10,
                                          ),
                                          Flexible(
                                            child: Column(
                                              children: [
                                                ...
                                                Text(AppLocalizations.of(context)?.translate("Block") ?? "Block",
                                                    style: Theme.of(context).textTheme.bodySmall!,
                                                    maxLines: 2,
                                                    softWrap: true),
                                              ],
                                    ...
                                    InkWell(
                                                          ...
                                                          Center(
                                                              child: Text(
                                                                  ...
                                                                  style: Theme.of(context)
                                                                      ...
                                                                      .copyWith(fontSize: 22))),
                                                          Center(
                                                              child: Text(' ${widget.resiverUseremail}',
                                                                  style: Theme.of(context)
                                                                      .textTheme
                                                                      .headlineSmall!
                                                                      .copyWith(fontSize: 22))),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          const Image(
                                              image: AssetImage("assets/icons/report.png"), height: 20, width: 20),
                                          const SizedBox(
                                            width: 10,
                                          ),
                                          Flexible(
                                            child: Column(
                                              children: [
                                                Text(AppLocalizations.of(context)?.translate("Report") ?? "Report",
                                                    style: Theme.of(context).textTheme.bodySmall!,
                                                    maxLines: 2,
                                                    softWrap: true),
                                              ],
              ...
              return Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      commonSimmer(height: 10, radius: 10, width: MediaQuery.of(context).size.width * 0.3),
                      const SizedBox(
                        height: 10,
                      ),
                      commonSimmer(height: 10, radius: 10, width: MediaQuery.of(context).size.width * 0.1),
                    ],
                  ),
                ],
              );
