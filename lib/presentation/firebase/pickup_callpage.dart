...
class PickUpCall extends StatefulWidget {
  final Map userData;
  final bool isAudio;
  const PickUpCall({super.key, required this.userData, required this.isAudio});
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: NetworkImage("${Config.baseUrl}${widget.userData["propic"]}"), fit: BoxFit.cover),
              ),
            ),
                ...
                InkWell(
                  onTap: () {
                    ...
                    if (widget.isAudio) {
                      ...
                      navigatorKey.currentState?.push(MaterialPageRoute(
                          builder: (context) => PickUpAudioCall(
                                channel: widget.userData[ids],
                                userData: widget.userData,
                              )));
                    } else {
                      navigatorKey.currentState?.push(
                          MaterialPageRoute(builder: (context) => VideoCall(channel: widget.userData[ids])));
                    }
                  },
                  child: Container(
                    height: 60,
