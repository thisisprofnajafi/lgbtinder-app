...
class push_notification_screen extends StatefulWidget {
  const push_notification_screen({super.key});
              ...
              children: [
                ListTile(
                  ...
                  title: Padding(
                    ...
                    child: Text(AppLocalizations.of(context)?.translate("New Matches") ?? "New Matches",
                  ...
                  subtitle: Text(
                      AppLocalizations.of(context)?.translate("You just got a new match.") ??
                ...
                ListTile(
                  ...
                  title: Padding(
                    ...
                    child: Text(AppLocalizations.of(context)?.translate("Message") ?? "Message",
                        style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.bold)),
                  ),
                  ...
                  subtitle: Text(
                      AppLocalizations.of(context)?.translate("Someone sent you a new message.") ??
                ...
                ListTile(
                  ...
                  title: Padding(
                    ...
                    child: Text(AppLocalizations.of(context)?.translate("Message Likes") ?? "Message Likes",
                        style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.bold)),
                    // child: Text('Message Likes'.tr,style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.bold)),
                  ...
                  subtitle: Text(
                      AppLocalizations.of(context)?.translate("Someone liked your message.") ??
                ...
                ListTile(
                  ...
                  title: Padding(
                    ...
                    child: Text(AppLocalizations.of(context)?.translate("Super Likes") ?? "Super Likes",
                        style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.bold)),
                  ),
                  ...
                  subtitle: Text(
                      AppLocalizations.of(context)?.translate("You`ve been Super Liked.") ??
