          ...
          child: MainButton(
              ...
              onTap: () {
                if (editProvider.mobileNumber.text.compareTo(
                        Provider.of<HomeProvider>(context, listen: false).userlocalData.userLogin!.mobile!) !=
                    0) {
                  BlocProvider.of<EditProfileCubit>(context)
                      .mobileCheckApi(number: editProvider.mobileNumber.text, ccode: editProvider.ccode)
                      .then((value) {
                    if (value == "true") {
                      BlocProvider.of<EditProfileCubit>(context).sendOtpFunction(
                          number: "+${editProvider.ccode} ${editProvider.mobileNumber.text}", context: context);
                    }
                  });
                } else {
                  ...
                  SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Wrap(runSpacing: 10, spacing: 10, runAlignment: WrapAlignment.center, children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image:
                                              NetworkImage("${Config.baseUrl}${editProvider.networkOldImage[a]}"),
                                          fit: BoxFit.cover)),
                                ),
                                Positioned(
                                  top: -5,
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(12),
                                      image: DecorationImage(
                                          image: FileImage(File(editProvider.newImage[a].path.toString())),
                                          fit: BoxFit.cover)),
                                ),
                                Positioned(
                                  top: -5,
                          ...
                          InkWell(
                            onTap: () async {
                              final XFile? image =
                                  await editProvider.picker.pickImage(source: ImageSource.gallery);
                        ...
                        commenTile(
                            titile: AppLocalizations.of(context)?.translate("Nick name") ?? "Nick name",
                            widget: TextFieldPro(
                              controller: editProvider.name,
                              // hintText: "First Name".tr,
                              hintText: AppLocalizations.of(context)?.translate("First Name") ?? "First Name",
                              onChangee: (e) {
                                editProvider.updateNameFiled(controller: editProvider.name, value: e);
                              },
                        ...
                        commenTile(
                            titile: AppLocalizations.of(context)?.translate("Email") ?? "Email",
                            widget: TextFieldPro(
                              controller: editProvider.email,
                              // hintText: "Email".tr,
                              hintText: AppLocalizations.of(context)?.translate("Email") ?? "Email",
                              onChangee: (e) {
                                editProvider.updateNameFiled(controller: editProvider.email, value: e);
                              },
                              textalingn: TextAlign.start,
                            ),
                            traing: true),
                        ...
                        commenTile(
                            titile: AppLocalizations.of(context)?.translate("Mobile Number") ?? "Mobile Number",
                            widget: IntlPhoneField(
                              ...
                              onChanged: (value) {
                                editProvider.updateNameFiled(
                                    controller: editProvider.mobileNumber, value: value.number);
                              },
                              decoration: InputDecoration(
                                helperText: null,
                                // hintText: "Mobile Number".tr,
                                hintText:
                                    AppLocalizations.of(context)?.translate("Mobile Number") ?? "Mobile Number",
                                isDense: true,
                                filled: true,
                              ...
                              invalidNumberMessage:
                                  AppLocalizations.of(context)?.translate("Please enter your mobile number") ??
                        ...
                        commenTile(
                            titile: AppLocalizations.of(context)?.translate("Password") ?? "Password",
                            widget: TextFieldPro(
                                surfixOntap: () {
                                ...
                                suffixIconPath:
                                    editProvider.obsText ? "assets/icons/eye-slash.svg" : "assets/icons/eye.svg",
                            ...
                            Row(
                              children: [
                                ...
                                RichText(
                                  ...
                                  TextSpan(
                                    text: editProvider.radius.toStringAsFixed(2),
                                    style: Theme.of(context).textTheme.bodySmall,
                                  ),
                                  // TextSpan(text: " KM".tr,style: Theme.of(context).textTheme.bodySmall,),
                                  TextSpan(
                                    text: AppLocalizations.of(context)?.translate(" KM") ?? " KM",
                                    style: Theme.of(context).textTheme.bodySmall,
                                  ),
                                ])),
                              ],
                        ...
                        commenTile(
                            titile: AppLocalizations.of(context)?.translate("Birthdate") ?? "Birthdate",
                            widget: Row(
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                                "${editProvider.bdatePicker}" != "null"
                                                    ? editProvider.bdatePicker.toString().split(" ").first
                                                    : "YYYY - MM - DD",
                                                style: Theme.of(context).textTheme.bodyMedium!),
                                          ),
                                        ],
                        ...
                        commenTile(
                            titile: AppLocalizations.of(context)?.translate("Bio") ?? "Bio",
                            widget: TextFieldPro(
                              controller: editProvider.bio,
                              // hintText: "Bio".tr,
                              hintText: AppLocalizations.of(context)?.translate("Bio") ?? "Bio",
                              onChangee: (e) {
                                editProvider.updateNameFiled(controller: editProvider.bio, value: e);
                              },
                              textalingn: TextAlign.start,
                            ),
                            traing: true),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              runSpacing: 13,
                              children: [
                                for (int a = 0; a < editProvider.manWoman.length; a++)
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(editProvider.manWoman[a].toString(),
                                            style: Theme.of(context).textTheme.bodySmall!.copyWith(
                                                color: editProvider.gender == a ? AppColors.white : null)),
                                      ),
                                    );
                                  })
                              ],
                                          ...
                                          body: SingleChildScrollView(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                editProvider.hobieSearchContoller.text.isEmpty
                                                    ? Wrap(
                                                            ...
                                                            Builder(builder: (context) {
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      color: editProvider.interestList
                                                                              .contains(data.id)
                                                                          ? AppColors.appColor
                                                                          : Theme.of(context).cardColor,
                                                                      borderRadius: BorderRadius.circular(40),
                                                    ...
                                                    : editProvider.searchForHobie.isEmpty
                                                        ? const SizedBox()
                                                        : Wrap(
                                                            alignment: WrapAlignment.start,
                                                            spacing: 13,
                                                            ...
                                                            children: [
                                                              for (int a = 0;
                                                                  a < editProvider.searchForHobie.length;
                                                                  a++)
                                                                Builder(builder: (context) {
                                                                  var result = editProvider.searchForHobie[a];
                                                                  Interestlist data =
                                                                      editProvider.interest![result];
                                                                  return InkWell(
                                                                    onTap: () {
                                                                      if (editProvider.interestList
                                                                              .contains(data.id) ==
                              ...
                              Row(
                                children: [
                                  ...
                                  SvgPicture.asset(
                                    ...
                                    colorFilter:
                                        ColorFilter.mode(Theme.of(context).indicatorColor, BlendMode.srcIn),
                                  )
                                ],
                              ),
                              const SizBoxH(size: 0.008),
                              Wrap(
                                ...
                                children: [
                                  for (int a = 0; a < editProvider.interest!.length; a++)
                                    Builder(builder: (context) {
                                      Interestlist data = editProvider.interest![a];
                                      return (editProvider.interestList.contains(data.id))
                                          ? Container(
                                              margin: const EdgeInsets.symmetric(horizontal: 5),
                                              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                              decoration: BoxDecoration(
                                    ...
                                    builder: (context, bottomSheet, child) {
                                      return Container(
                                        ...
                                        child: Scaffold(
                                          bottomNavigationBar: MainButton(
                                            bgColor: AppColors.appColor,
                                            title: "Ok(${editProvider.languageList.length}/5)",
                                            onTap: () {
                                              Navigator.pop(context);
                                            },
                                          ),
                                          body: SingleChildScrollView(
                                            child: Column(
                                              ...
                                              children: [
                                                TextField(
                                                  controller: editProvider.languageSearchContoller,
                                                  style: Theme.of(context).textTheme.bodySmall!,
                                                  decoration: InputDecoration(
                                                    fillColor: Theme.of(context).cardColor,
                                                    filled: true,
                                                  ...
                                                  onChanged: (c) {
                                                    editProvider.searchLanguage(c);
                                                  },
                                                ),
                                                const SizedBox(
                                                  height: 15,
                                                ),
                                                editProvider.languageSearchContoller.text.isEmpty
                                                    ? Wrap(
                                                        alignment: WrapAlignment.start,
                                                        spacing: 13,
                                                        runSpacing: 13,
                                                        children: [
                                                          for (int a = 0; a < editProvider.language!.length; a++)
                                                            Builder(builder: (context) {
                                                              Languagelist data = editProvider.language![a];
                                                              return InkWell(
                                                                onTap: () {
                                                                  if (editProvider.languageList
                                                                          .contains(data.id) ==
                                                                      true) {
                                                                ...
                                                                child: Container(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12, vertical: 8),
                                                                  decoration: BoxDecoration(
                                                                      color: editProvider.languageList
                                                                              .contains(data.id)
                                                                          ? AppColors.appColor
                                                                          : Theme.of(context).cardColor,
                                                                      borderRadius: BorderRadius.circular(40),
                                                    ...
                                                    : editProvider.searchForLanguage.isEmpty
                                                        ? const SizedBox()
                                                        : Wrap(
                                                            alignment: WrapAlignment.start,
                                                            spacing: 13,
                                                            ...
                                                            children: [
                                                              for (int a = 0;
                                                                  a < editProvider.searchForLanguage.length;
                                                                  a++)
                                                                Builder(builder: (context) {
                                                                  var result = editProvider.searchForLanguage[a];
                                                                  Languagelist data =
                                                                      editProvider.language![result];
                                                                  return InkWell(
                                                                    onTap: () {
                                                                      if (editProvider.languageList
                                                                              .contains(data.id) ==
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                    // "Languages I Know".tr,
                                    AppLocalizations.of(context)?.translate("Languages I Know") ??
                                        "Languages I Know",
                                    style: Theme.of(context).textTheme.bodyLarge!,
                                  ),
                                  const Spacer(),
                              ...
                              Wrap(
                                ...
                                children: [
                                  for (int a = 0; a < editProvider.language!.length; a++)
                                    Builder(builder: (context) {
                                      Languagelist data = editProvider.language![a];
                                      return (editProvider.languageList.contains(data.id))
                                          ? Container(
                                              margin: const EdgeInsets.symmetric(horizontal: 5),
                                              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                              decoration: BoxDecoration(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              runSpacing: 13,
                              children: [
                                for (int a = 0; a < editProvider.searchPref.length; a++)
                                  Builder(builder: (context) {
                                    return InkWell(
                                      onTap: () {
                                      ...
                                      child: Container(
                                        ...
                                        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                        decoration: BoxDecoration(
                                            color: editProvider.searchPreference == a
                                                ? AppColors.appColor
                                                : Theme.of(context).cardColor,
                                            borderRadius: BorderRadius.circular(40),
                                            border: Border.all(
                                      ...
                                      return Container(
                                        ...
                                        child: Scaffold(
                                          ...
                                          body: ListView.separated(
                                              ...
                                              shrinkWrap: true,
                                              itemCount: editProvider.relationShip!.length,
                                              itemBuilder: (c, i) {
                                                Goallist? data = editProvider.relationShip![i];
                                                return InkWell(
                                                  onTap: () {
                                                    editProvider.updaterelationGoal(int.parse(data.id.toString()));
                                                  },
                                                  child: Container(
                                                    // height: 55,
                              ...
                              Row(
                                children: [
                                  Text(
                                    ...
                                    AppLocalizations.of(context)?.translate("Relationship Goals") ??
                                        "Relationship Goals",
                                    style: Theme.of(context).textTheme.bodyLarge!,
                                  ),
                                  const Spacer(),
                              ...
                              Wrap(
                                ...
                                children: [
                                  for (int a = 0; a < editProvider.relationShip!.length; a++)
                                    Builder(builder: (context) {
                                      Goallist data = editProvider.relationShip![a];
                                      return (int.parse(data.id.toString()) == editProvider.selectRelationShip)
                                          ? Container(
                                              margin: const EdgeInsets.symmetric(horizontal: 5),
                                              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                              decoration: BoxDecoration(
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Center(
                                  child: Text(
                                AppLocalizations.of(context)?.translate("New") ?? "New",
                        ...
                        ListTile(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(AppLocalizations.of(context)?.translate("cm") ?? "cm",
                                                            style: Theme.of(context)
                                                                .textTheme
                                                                .bodyLarge!
                            ...
                            title: editProvider.heightcontrooler.text.isEmpty
                                ? const Text("Not Updated")
                                : Text("${editProvider.heightcontrooler.text} cm"),
