...
class EditProfileProvider extends ChangeNotifier {
  ...
  searchLanguage(s) {
    ...
    for (int i = 0; i < language!.length; i++) {
      if (language![i].title.toString().toLowerCase().contains(s.toLowerCase())) {
  ...
  searchHobie(s) {
    ...
    for (int i = 0; i < interest!.length; i++) {
      if (interest![i].title.toString().toLowerCase().contains(s.toLowerCase())) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(AppLocalizations.of(context)?.translate("Awesome") ?? "Awesome",
                    ...
                    OTPTextField(
                      ...
                      otpFieldStyle: OtpFieldStyle(
                          ...
                          disabledBorderColor: Theme.of(context).indicatorColor,
