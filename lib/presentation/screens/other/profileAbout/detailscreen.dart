...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: BlocBuilder<HomePageCubit, HomePageStates>(builder: (context, state) {
          if (state is HomeCompleteState) {
            return Container(
              padding: const EdgeInsets.symmetric(vertical: 6, horizontal: 8),
              decoration: BoxDecoration(
                color:
                    (detailProvider.status != "1" && detailProvider.status != "3" && state.homeData.planId != "3")
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => ChattingPage(
                                              ...
                                              resiverUserId:
                                                  detailProvider.detailModel.profileinfo!.profileId.toString(),
                                              resiverUseremail:
                                                  detailProvider.detailModel.profileinfo!.profileName.toString(),
                                            )));
                              },
                              child: Container(
                                height: 55,
                ...
                slivers: [
                  SliverAppBar(
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                color: Colors.white.withOpacity(0.4), borderRadius: BorderRadius.circular(20)),
                            child: BackdropFilter(
                              filter: ImageFilter.blur(sigmaX: 10, sigmaY: 10),
                              child: RichText(
                                  text: TextSpan(children: [
                                TextSpan(
                                  text: "${detailProvider.detailModel.profileinfo!.profileDistance} ",
                                    ...
                                    Column(children: [
                                              ...
                                              title: Column(
                                                children: [
                                                  SizedBox(
                                                    height: 200,
                                                    width: 200,
                                                    child: Lottie.asset('assets/lottie/block.json',
                                                        fit: BoxFit.cover),
                                                  ),
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: ElevatedButton(
                                                          onPressed: () {
                                                            Navigator.pop(context);
                                                            detailProvider.profileblockApi(
                                                                context: context,
                                                                profileblock:
                                      ...
                                      InkWell(
                                                  ...
                                                  child: AlertDialog(
                                                    ...
                                                    title: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                            AppLocalizations.of(context)
                                                                    ?.translate("Why did you report this user?") ??
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            const Image(
                                                image: AssetImage("assets/icons/report.png"),
                                                height: 20,
                                                width: 20),
                                            const SizedBox(
                                              width: 10,
                    ...
                    bottom: PreferredSize(
                      ...
                      child: Column(
                        children: [
                          detailProvider.detailModel.profileinfo!.profileImages!.length > 1
                              ? SizedBox(
                                  height: 25,
                                  width: MediaQuery.of(context).size.width,
                                  child: Row(
                                    ...
                                    children: [
                                      ...List.generate(
                                          detailProvider.detailModel.profileinfo!.profileImages!.length, (index) {
                                        return Indicator(
                                          isActive: detailProvider.slider == index ? true : false,
                                        );
                                      }),
                                    ],
                                  ),
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      background: CarouselSlider.builder(
                          itemCount: detailProvider.detailModel.profileinfo!.profileImages!.length,
                          ...
                          options: CarouselOptions(
                              ...
                              height: MediaQuery.of(context).size.height / 2,
                              autoPlay:
                                  detailProvider.detailModel.profileinfo!.profileImages!.length > 1 ? true : false,
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              detailProvider.detailModel.profileinfo!.isVerify == "0"
                                  ? const Padding(
                                  ...
                                  : detailProvider.detailModel.profileinfo!.isVerify == "2"
                                      ? const Padding(
                                          padding: EdgeInsets.only(top: 4.0),
                                          child: Image(
                          ...
                          Wrap(
                            ...
                            children: [
                              for (int a = 0;
                                  a < detailProvider.detailModel.profileinfo!.interestList!.length;
                                  a++)
                                Builder(builder: (context) {
                                  InterestListElement data =
                                      detailProvider.detailModel.profileinfo!.interestList![a];
                                  return InkWell(
                                    onTap: () {
                          ...
                          Wrap(
                            ...
                            children: [
                              for (int a = 0;
                                  a < detailProvider.detailModel.profileinfo!.languageList!.length;
                                  a++)
                                Builder(builder: (context) {
                                  InterestListElement data =
                                      detailProvider.detailModel.profileinfo!.languageList![a];
                          ...
                          Text(
                            AppLocalizations.of(context)?.translate("Relationship") ?? "Relationship",
                            style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                  letterSpacing: 0.8,
                                  fontSize: 14,
                                  height: 0,
                          ...
                          const SizedBox(height: 5),
                          detailProvider.detailModel.profileinfo!.relationTitle != null
                              ? Text(
                                  detailProvider.detailModel.profileinfo!.relationTitle!,
                                  style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
                                )
                              : const SizedBox(),
                          const SizedBox(height: 20),
