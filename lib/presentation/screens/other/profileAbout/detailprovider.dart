...
class DetailProvider extends ChangeNotifier {
  ...
  Future detailsApi(
      {required String uid, required String lat, required String long, required String profileId}) async {
    try {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Fluttertoast.showToast(
            msg: AppLocalizations.of(context)?.translate("Something went Wrong....!!!") ??
