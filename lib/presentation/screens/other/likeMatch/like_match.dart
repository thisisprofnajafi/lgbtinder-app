...
class LikeMatchScreen extends StatefulWidget {
  ...
  const LikeMatchScreen({super.key});
              ...
              Padding(
                ...
                child: RichText(
                    ...
                    text: TextSpan(children: [
                      ...
                      TextSpan(
                          text: AppLocalizations.of(context)?.translate("You and ") ?? "You and ",
                          style: Theme.of(context)
                              .textTheme
                              .headlineSmall!
                              .copyWith(color: AppColors.appColor, fontSize: 25)),
                      TextSpan(
                          text: "${likeMatchProvider.likeMatchData[likeMatchProvider.interIndex].profileName}",
                          style: Theme.of(context)
                              .textTheme
                              .headlineSmall!
                              .copyWith(color: AppColors.appColor.withOpacity(0.5), fontSize: 25)),
                      ...
                      TextSpan(
                          text: AppLocalizations.of(context)?.translate(" liked each other!") ??
                              " liked each other!",
                          style: Theme.of(context)
                              .textTheme
                              .headlineSmall!
                      ...
                      options: CarouselOptions(
                          ...
                          onPageChanged: (i, r) {
                            if (likeMatchProvider.isHome) {
                              likeMatchProvider.profileViewApi(
                                  uid: Provider.of<HomeProvider>(context, listen: false).uid,
                                  profileId: likeMatchProvider.likeMatchData[i].profileId);
                            }
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    MainButton(
                      title: AppLocalizations.of(context)?.translate("Send a message") ?? "Send a message",
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => ChattingPage(
                                  resiverUserId:
                                      likeMatchProvider.likeMatchData[likeMatchProvider.interIndex].profileId,
                                  resiverUseremail:
                                      likeMatchProvider.likeMatchData[likeMatchProvider.interIndex].profileName,
                                  proPic: likeMatchProvider
                                      .likeMatchData[likeMatchProvider.interIndex].profileImages.first),
                            ));
                      },
                    ),
                    const SizedBox(
                    ...
                    MainButton(
                      title: AppLocalizations.of(context)?.translate("Keep Swiping") ?? "Keep Swiping",
