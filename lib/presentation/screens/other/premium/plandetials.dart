          ...
          child: Row(
            children: [
              Expanded(
                ...
                child: MainButton(
                  title: AppLocalizations.of(context)?.translate("Upgrade") ?? "Upgrade",
                  onTap: () {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                          AppLocalizations.of(context)?.translate("You're Activated Membership!") ??
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(state.homeData.plandata!.planDescription.toString(),
                      ...
                      Row(children: [
                        ...
                        Text(AppLocalizations.of(context)?.translate("Payment method") ?? "Payment method",
                      ...
                      Row(children: [
                        ...
                        Text(AppLocalizations.of(context)?.translate("transaction id") ?? "transaction id",
                            style: Theme.of(context).textTheme.bodySmall),
                        const Spacer(),
                      ...
                      Row(children: [
                        ...
                        Text(AppLocalizations.of(context)?.translate("Date of Purchase") ?? "Date of Purchase",
                            style: Theme.of(context).textTheme.bodySmall),
                        const Spacer(),
                        Text(state.homeData.plandata!.planStartDate.toString().split(' ').first,
                            style: Theme.of(context).textTheme.bodyMedium),
                      ]),
                      const SizedBox(
                        height: 10,
                      ...
                      Row(children: [
                        ...
                        Text(AppLocalizations.of(context)?.translate("Date of Expiry") ?? "Date of Expiry",
                            style: Theme.of(context).textTheme.bodySmall),
                        const Spacer(),
                        Text(state.homeData.plandata!.planEndDate.toString().split(' ').first,
                            style: Theme.of(context).textTheme.bodyMedium),
                      ]),
                      Divider(
                        height: 20,
                      ...
                      Row(children: [
                        ...
                        Text(AppLocalizations.of(context)?.translate("Membership Amount") ?? "Membership Amount",
                            style: Theme.of(context).textTheme.bodySmall),
                        const Spacer(),
                        Text(
