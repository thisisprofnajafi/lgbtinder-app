...
class _PremiumScreenState extends State<PremiumScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      bottomNavigationBar: BlocBuilder<PremiumBloc, PremiumState>(builder: (context, state) {
              ...
              return
                ...
                child: Row(
                  children: [
                    Expanded(
                        child: MainButton(
                      titleColor: state1.homeData.planId == premiumProvider.selectedPlan.toString()
                          ? AppColors.black
                          : AppColors.white,
                      bgColor: state1.homeData.planId == premiumProvider.selectedPlan.toString()
                      ...
                      onTap: () {
                        if (premiumProvider.selectedPlan > 0) {
                          state1.homeData.planId == premiumProvider.selectedPlan.toString()
                              ? null
                                                  ...
                                                  if (premiumProvider.selectedPayment == 1) {
                                                    _razorPayClass.openCheckout(
                                                      name: Provider.of<HomeProvider>(context, listen: false)
                                                          ...
                                                          .name
                                                          .toString(),
                                                      number: Provider.of<HomeProvider>(context, listen: false)
                                                          .userlocalData
                                                          .userLogin!
                                                          .mobile
                                                          .toString(),
                                                    ...
                                                    List ids = premiumProvider.selectedPaymentattributes
                                                        .toString()
                                                        .split(",");
                                                    print('++++++++++ids:------$ids');
                                                    paypalPayment(
                                                    ...
                                                    var userID = Provider.of<HomeProvider>(context, listen: false).userlocalData.userLogin!.id.toString();

                                                    var email = Provider.of<HomeProvider>(context, listen: false).userlocalData.userLogin!.email.toString();
                                                    _paymentCard.name = username;
                                                    _paymentCard.userId = userID;
                                                    _paymentCard.email = email;
                                                    _paymentCard.amount = premiumProvider.selectedPlanPrice.toString();
                                                    _paymentCard.planId = premiumProvider.selectedPlan.toString();
                                                    Navigator.push(
                                                        context,
                                                        MaterialPageRoute(
                                                          builder: (context) => StripePaymentWeb(paymentCard: _paymentCard),
                                                        )).then((otid) {
                                                      Navigator.pop(context);
                                                      if (otid != null) {
                                                        BlocProvider.of<PremiumBloc>(context).planPurchase(
                                                    ...
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      ...
                                                      SnackBar(
                                                        content: Text(
                                                            AppLocalizations.of(context)?.translate("Not Valid") ??
                                                                "Not Valid"),
                                                    ...
                                                    Navigator.push(
                                                        context,
                                                        MaterialPageRoute(
                                                          builder: (context) => Flutterwave(
                                                            totalAmount: premiumProvider.selectedPlanPrice
                                                                .toStringAsFixed(2),
                                                            email:
                                                      ...
                                                      if (otid != null) {
                                                        ...
                                                        Fluttertoast.showToast(
                                                            msg: AppLocalizations.of(context)
                                                                    ?.translate("Payment Successfully") ??
                                          ...
                                          builder: (BuildContext context, value, Widget? child) {
                                            return ListView.separated(
                                                ...
                                                padding: const EdgeInsets.only(
                                                    top: 10.0, bottom: 50, right: 10, left: 10),
                                                shrinkWrap: true,
                                                  ...
                                                  return InkWell(
                                                    onTap: () {
                                                      ...
                                                      value.updateSelectPayment(
                                                          int.parse(state.payment[index].id.toString()));
                                                      value.updateAttributes(
                                                          state.payment[index].attributes.toString());
                                                      value.updatePaymentName(
                                                          state.payment[index].title.toString());
                                                    },
                                                    child: Container(
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Text(state.payment[index].title.toString(),
                                                                    style:
                                                                        Theme.of(context).textTheme.bodyMedium!),
                                                                const SizedBox(
                                                                  height: 2,
                                                                ),
                                                                Text(state.payment[index].subtitle.toString(),
                          ...
                          Fluttertoast.showToast(
                              msg: AppLocalizations.of(context)?.translate("Select Plan") ?? "Select Plan");
                        }
                      },
                    ))
                  ],
                            ...
                            return state.planData[index].status == "1"
                                ? Stack(
                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          if (int.parse(state1.homeData.planId.toString()) <=
                                              int.parse(state.planData[index].id.toString())) {
                                            premiumProvider.updateSelectPlan(int.parse(state.planData[index].id!));
                                            premiumProvider
                                                .updateSelectPlanPrice(double.parse(state.planData[index].amt!));
                                          }
                                        },
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              border: Border.all(
                                                  color: premiumProvider.selectedPlan ==
                                                          int.parse(state.planData[index].id!)
                                                      ? AppColors.appColor
                                                      : Theme.of(context).dividerTheme.color!,
                                                  width: premiumProvider.selectedPlan ==
                                                          int.parse(state.planData[index].id!)
                                                      ? 3
                                                      : 2)),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [
                                              Text(state.planData[index].description.toString(),
...
//Strip code
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              AppLocalizations.of(context)?.translate("Add Your payment information") ??
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  onSaved: (String? value) {
                                    ...
                                    CardTypee cardType =
                                        CardUtils.getCardTypeFrmNumber(_paymentCard.number.toString());
                                    setState(() {
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        ...
                                        AppLocalizations.of(context)
                                                ?.translate("What number is written on card?") ??
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            ...
                                            hintText: AppLocalizations.of(context)
                                                    ?.translate("Number behind the card") ??
                                    ...
                                    Flexible(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          labelText: AppLocalizations.of(context)?.translate("Expiry Date") ??
                                              "Expiry Date",
                                        ),
  ...
  void _validateInputs() {
    ...
    if (!form.validate()) {
      ...
      Fluttertoast.showToast(
          msg: AppLocalizations.of(context)?.translate("Please fix the errors in red before submitting.") ??
              "Please fix the errors in red before submitting.",
          timeInSecForIosWeb: 4);
    } else {
      print("prof the payment is herer =======================================================================================");
      var username = Provider.of<HomeProvider>(context, listen: false).userlocalData.userLogin!.name.toString();
      ...
      Fluttertoast.showToast(
          msg: AppLocalizations.of(context)?.translate("Payment card is valid") ?? "Payment card is valid",
          timeInSecForIosWeb: 4);
    }
  }
}
