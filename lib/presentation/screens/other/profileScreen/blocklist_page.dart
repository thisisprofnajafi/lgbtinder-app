                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      ...
                                      SvgPicture.asset("assets/Image/Rectangle.svg",
                                          fit: BoxFit.fitWidth,
                                          colorFilter: ColorFilter.mode(
                                              AppColors.appColor.withOpacity(0.8), BlendMode.srcIn)),
                                      Container(
                                        height: 30,
                                        width: 80,
                                        decoration: BoxDecoration(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Padding(
                                                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                                                child: Text(
                                                    profileProvider.blocklistApi.blocklist![index].profileBio
                                                        .toString()
                                                        .toUpperCase(),
                                                    style: Theme.of(context).textTheme.bodySmall!.copyWith(
                                                        color: Colors.white, wordSpacing: 2, fontSize: 12),
                                                    maxLines: 2,
                                                    textAlign: TextAlign.center,
                                                    overflow: TextOverflow.ellipsis),
                                              ),
