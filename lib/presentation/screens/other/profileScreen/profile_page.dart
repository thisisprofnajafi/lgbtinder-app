...
class _ProfilePageState extends State<ProfilePage> {
  ...
  late Future<dynamic> _initializeControllerFuture;
  ...
  void initState() {
    ...
    //imagecontroller = CameraController(cameras.first, ResolutionPreset.medium);
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: BlocBuilder<HomePageCubit, HomePageStates>(builder: (context1, state) {
                    ...
                    Row(
                      ...
                      children: [
                                ...
                                : SizedBox(
                                    ...
                                    child: CircularProgressIndicator(
                                        ...
                                        value: (double.parse(state
                                                .homeData.profilelist![homeProvider.currentIndex].matchRatio
                                                .toString()
                                                .split(".")
                                                .first) /
                                            100)),
                                ...
                                : selectImageprofile == null
                                    ...
                                    : Container(
                                        ...
                                        decoration: BoxDecoration(
                                          shape: BoxShape.circle,
                                          image: DecorationImage(
                                              image: FileImage(File(selectImageprofile!.path)), fit: BoxFit.cover),
                                        ),
                                      ),
                                                  ...
                                                  children: [
                                                    Center(
                                                        child: Icon(Icons.camera_alt,
                                                            color: AppColors.appColor, size: 30)),
                                                    const SizedBox(
                                                      height: 10,
                                                    ),
                                                    ...
                                                    Text(
                                                      AppLocalizations.of(context)
                                                              ?.translate("We want to know it`s really you.") ??
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Text(
                                                        AppLocalizations.of(context)
                                                                ?.translate("Tack a quick video selfie") ??
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              Center(
                                                                                                child: ClipOval(
                                                                                                  child: SizedBox(
                                                                                                    height: 350,
                                                                                                    width: 230,
                                                                                                    child: selectImageprofilevaridfy ==
                                                                                                            null
                                                                                                        ? GestureDetector(
                                                                                                            onDoubleTap:
                                                                                                                () {
                                                                                                        ...
                                                                                                        : Image.file(
                                                                                                            File(selectImageprofilevaridfy!
                                                                                                                .path),
                                                                                                            fit: BoxFit
                                                                                                                .cover),
                                                                                                  ),
                                                                                              ...
                                                                                              Center(
                                                                                                ...
                                                                                                AppLocalizations.of(
                                                                                                            context)
                                                                                                        ?.translate(
                                                                                                            "Make sure to frame your face in the oval, then tap  'I am Ready'!") ??
                                                                                                    "Make sure to frame your face in the oval, then tap  'I am Ready'!",
                                                                                                style: Theme.of(
                                                                                                        context)
                                                                                                    .textTheme
                                      ...
                                      : state.homeData.isVerify == "1"
                                          ? InkWell(
                                              ...
                                              child: const Padding(
                                                padding: EdgeInsets.only(top: 4.0),
                                                child: Image(
                                                  image: AssetImage("assets/icons/progressicon.png"),
                                                  height: 22,
                                                  width: 22,
                                                ),
                                              ),
                                          ...
                                          : const Padding(
                                              padding: EdgeInsets.only(top: 4.0),
                                              child: Image(
                                                image: AssetImage("assets/icons/approveicon.png"),
                                                height: 22,
                                                width: 22,
                                              ),
                                            ),
                        ...
                        InkWell(
                                      ...
                                      child: SingleChildScrollView(
                                        child: Column(
                                          children: [
                                            ...
                                            Text(
                                              AppLocalizations.of(context)
                                                      ?.translate("From where do you want to take the photo?") ??
                                                  ...
                                                  child: MainButton(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        if (picked != null) {
                                                          ...
                                                          List<int> imageByte =
                                                              File(selectImageprofile!.path).readAsBytesSync();
                                                          base64String = base64Encode(imageByte);

                                                          profileProvider
                                                              .profilepicApi(
                                                                  context: context, img: base64String.toString())
                                                              .then((value) {
                                                            Navigator.of(context).pop();
                                                            setState(() {});
                                                          });
                          ...
                          child: Container(
                            decoration:
                                BoxDecoration(color: AppColors.appColor, borderRadius: BorderRadius.circular(20)),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                              image: AssetImage("assets/Image/profileBg.png"), fit: BoxFit.cover),
                        ),
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        state.homeData.planId != "0"
                                            ...
                                            : AppLocalizations.of(context)
                                                    ?.translate("Join Our Membership Today!") ??
                                    ...
                                    Text(
                                        state.homeData.planId != "0"
                                            ? AppLocalizations.of(context)
                                                    ?.translate("Enjoy  premium and match anywhere.") ??
                                                "Enjoy  premium and match anywhere."
                                            : AppLocalizations.of(context)?.translate("Checkout GoMeet Premium") ??
                                                "Checkout LGBTinder Premium",
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodySmall!
                          ...
                          return i == 2
                              ? profileProvider.isLoading
                                  ? ListView.builder(
                                        ...
                                        return ListTile(
                                          onTap: () {
                                            Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) => Loream(
                                                      title: profileProvider.privacyPolicy.pagelist![index].title
                                                          .toString(),
                                                      discription: profileProvider
                                                          .privacyPolicy.pagelist![index].description
                                                          .toString()),
                                                ));
                                          },
                                          dense: true,
                                      ...
                                      itemCount: profileProvider.privacyPolicy.pagelist!.length)
                                  : const SizedBox()
                              : ListTile(
                                  onTap: () async {
                                    if (i == 0) {
                                      ...
                                      profileProvider.blocklistaApi(context).then((value) {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => const profile_privacyy(),
                                            ));
                                        setState(() {});
                                      });
                                    } else if (i == 5) {
                                  ...
                                  leading: SizedBox(
                                    ...
                                    child: Center(
                                      child: SvgPicture.asset(
                                        ...
                                        colorFilter: ColorFilter.mode(
                                            profileProvider.menuList[i]["iconShow"] == "0"
                                                ? Colors.red
                                  ...
                                  title: Text(
                                    AppLocalizations.of(context)
                                            ?.translate("${profileProvider.menuList[i]["title"]}") ??
                                        "${profileProvider.menuList[i]["title"]}",
                                    style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                                        color: profileProvider.menuList[i]["iconShow"] == "0" ? Colors.red : null),
                                  ),
                                  trailing: profileProvider.menuList[i]["iconShow"] == "2"
                                      ? SizedBox(
                                          height: 40,
                                          width: 30,
                                                  ...
                                                  onChanged: (r) async {
                                                    ...
                                                    if (r) {
                                                      BlocProvider.of<ThemeBloc>(context)
                                                          .addTheme(ThemeEvent.toggleDark);
                                                      setThemeData('dark');
                                                    } else {
                                                      BlocProvider.of<ThemeBloc>(context)
                                                          .addTheme(ThemeEvent.toggleLight);
                                                      setThemeData('lite');
                                                    }
                                                  })),
                                        )
                                      : profileProvider.menuList[i]["iconShow"] == "1"
                                          ? SvgPicture.asset(
