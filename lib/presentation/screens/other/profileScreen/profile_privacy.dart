...
class profile_privacyy extends StatefulWidget {
  const profile_privacyy({super.key});
                    ...
                    ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const Block_List(),
                            ));
                      },
                      contentPadding: EdgeInsets.zero,
                      title: Padding(
                        padding: const EdgeInsets.only(bottom: 4.0),
                        child: Text('Blocked Users (${profileProvider.blocklistApi.blocklist!.length})',
                      ...
                      subtitle: Text(
                          AppLocalizations.of(context)?.translate("The people you blocked are displayed here.") ??
                              "The people you blocked are displayed here.",
                          style:
                              Theme.of(context).textTheme.bodyMedium!.copyWith(color: Colors.grey, fontSize: 14)),
