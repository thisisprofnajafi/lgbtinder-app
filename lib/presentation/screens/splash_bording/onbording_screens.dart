            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    ...List.generate(onBordingProvider.onBordingData.length, (index) {
                      return Indicator(
              ...
              Text(onBordingProvider.onBordingData[onBordingProvider.onboradingCurrent]["title"],
                  style: Theme.of(context).textTheme.headlineSmall, textAlign: TextAlign.center, maxLines: 2),
              const SizedBox(
                height: 20,
              ),
              onBordingProvider.onboradingCurrent == onBordingProvider.onBordingData.length - 1
                  ? Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Expanded(
                          child: MainButton(
                            title: AppLocalizations.of(context)?.translate("Let's Start") ?? "Let's Start",
                            radius: 80,
                            onTap: () {
                              Navigator.pushNamedAndRemoveUntil(
                                  context, AuthScreen.authScreenRoute, (route) => false);
