              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    AppLocalizations.of(context)?.translate("Recover your account using your email address") ??
                  ...
                  TextFieldPro(
                      ...
                      hintText:
                          AppLocalizations.of(context)?.translate("Example@gmail.com") ?? "Example@gmail.com"),
                ],
              ),
            ),
            Padding(
                          ...
                          Flexible(
                            child: Text(
                              ...
                              AppLocalizations.of(context)
                                      ?.translate("We'll email you a link to connect to your account") ??
                                  "We'll email you a link to connect to your account",
                              style: Theme.of(context)
                                  .textTheme
                                  .titleMedium!
                                  .copyWith(color: AppColors.appColor, fontWeight: FontWeight.w400, fontSize: 14),
