                                                  ...
                                                  text: TextSpan(children: [
                                                    ...
                                                    TextSpan(
                                                        text: AppLocalizations.of(context)
                                                                ?.translate("Location (Within ") ??
                                                            "Location (Within ",
                                                        style: Theme.of(context).textTheme.bodySmall!),
                                                    TextSpan(
                                                        text: homeProvider.radius.toStringAsFixed(2),
                                                        style: Theme.of(context).textTheme.bodySmall!),
                                                    // TextSpan(text: " km)".tr,style: Theme.of(context)
                                                    TextSpan(
                                                        text: AppLocalizations.of(context)?.translate(" km)") ??
                                                            " km)",
                                                        style: Theme.of(context).textTheme.bodySmall!),
                                                  ])),
                                            ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(homeProvider.mapModel.profilelist![index].profileBio.toString(),
                                              style: Theme.of(context).textTheme.bodySmall!,
                                              maxLines: 1,
                                              overflow: TextOverflow.ellipsis),
                                        ],
                                    ...
                                    Container(
                                      ...
                                      child: Center(
                                          child: SvgPicture.asset('assets/icons/Heart-fill.svg',
