...
class HomeProvider extends ChangeNotifier {
  ...
  mapData({required String uid, required String lat, required String long, required String radius}) async {
    try {
      Map data = {"uid": uid, "lats": lat, "longs": long, "radius_search": radius};
        ...
        if (response.data["Result"] == "true") {
          ...
          for (int a = 0; a < mapModel.profilelist!.length; a++) {
            Map data = {
              ...
              "gkey": GlobalKey(),
              "position": LatLng(double.parse(mapModel.profilelist![a].profileLat.toString()),
                  double.parse(mapModel.profilelist![a].profileLongs.toString())),
              "widget": Container(
                height: 100,
                width: 100,
                alignment: Alignment.center,
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage("${Config.baseUrl}${mapModel.profilelist![a].profileImages![0]}"),
                        fit: BoxFit.fitHeight)),
  ...
  loadDataFrorMap(context) async {
    ...
    Map data = {
      ...
      "widget": SvgPicture.asset("assets/icons/mappincurrent.svg", height: 100, width: 100),
                ...
                children: [
                  ...
                  Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .bodyMedium!
                          .copyWith(color: AppColors.appColor, height: 1.2, fontWeight: FontWeight.w700),
                      textAlign: TextAlign.center),
                  const SizedBox(
                    height: 15,
                  ),
  ...
  void swipe(List state, context) {
    ...
    Future.delayed(const Duration(milliseconds: 400), () {
      ...
      BlocProvider.of<HomePageCubit>(context)
          .getHomeData(uid: uid, lat: lat.toString(), long: long.toString(), context: context)
          .then((value) {
        currentIndex = 0;
        notifyListeners();
      });
      ...
      builder: (context) {
        return Consumer<HomeProvider>(
          builder: (context, value, child) {
            return Consumer<EditProfileProvider>(builder: (context, editPro, child) {
              return ClipRRect(
                  ...
                  bottomNavigationBar: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            child: MainButton(
                          title: AppLocalizations.of(context)?.translate("Reset") ?? "Reset",
                          bgColor: const Color(0xffF7ECFF),
                          titleColor: AppColors.appColor,
                          onTap: () {
                            BlocProvider.of<HomePageCubit>(context)
                                .getHomeData(
                                    uid: uid, lat: lat.toString(), long: long.toString(), context: context)
                                .then((value) {
                        ...
                        Expanded(
                          child: MainButton(
                            ...
                            title: AppLocalizations.of(context)?.translate("Apply") ?? "Apply",
                            onTap: () {
                              BlocProvider.of<HomePageCubit>(context, listen: false)
                                  .filterHome(
                                      ...
                                      searchPreference: editPro.maleFemaleBoth(searchPreference),
                                      uid: uid,
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(editPro.searchPref[a].toString(),
                                              style: Theme.of(context).textTheme.bodySmall!.copyWith(
                                                  color: searchPreference == a ? AppColors.white : null)),
                                        ),
                                      );
                                    })
                                ],
                                      ...
                                      Builder(builder: (context) {
                                        ...
                                        return InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                            decoration: BoxDecoration(
                                                color: interestList.contains(data.id)
                                                    ? AppColors.appColor
                                                    : Theme.of(context).cardColor,
                                                borderRadius: BorderRadius.circular(40),
                                                border: Border.all(color: Theme.of(context).dividerTheme.color!)),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                runSpacing: 13,
                                children: [
                                  for (int a = 0; a < editPro.language!.length; a++)
                                    Builder(builder: (context) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                          decoration: BoxDecoration(
                                              color: languageList.contains(data.id)
                                                  ? AppColors.appColor
                                                  : Theme.of(context).cardColor,
                                              borderRadius: BorderRadius.circular(40),
                                              border: Border.all(color: Theme.of(context).dividerTheme.color!)),
                                    ...
                                    Builder(builder: (context) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                          decoration: BoxDecoration(
                                              color: selectRelationShip == int.parse(data.id.toString())
                                                  ? AppColors.appColor
                                                  : Theme.of(context).cardColor,
                                              borderRadius: BorderRadius.circular(40),
                                              border: Border.all(color: Theme.of(context).dividerTheme.color!)),
                                        ...
                                        itemBuilder: (context, index) {
                                          return GestureDetector(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color: selectverfy == int.parse(index == 0 ? "0" : "2")
                                                    ? AppColors.appColor
                                                    : Theme.of(context).cardColor,
                                                border: Border.all(
