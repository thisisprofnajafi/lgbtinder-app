                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: InkWell(
                                  ...
                                  child: SizedBox(
                                      ...
                                      width: 25,
                                      child: Center(
                                          child: SvgPicture.asset("assets/icons/times.svg",
                                              height: 22,
                                              width: 22,
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return ListTile(
                                              ...
                                              Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) => ChattingPage(
                                                      ...
                                                      resiverUseremail: chattingProvider.searchiteams[result]
                                                          ["name"],
                                                    ),
                                                  ));
                                            },
                                            ...
                                            subtitle: Text(chattingProvider.searchiteams[result]["message"],
                                                style: Theme.of(context).textTheme.bodySmall),
                                            trailing: Text(
                                                DateFormat('hh:mm a')
                                                    .format(DateTime.fromMicrosecondsSinceEpoch(chattingProvider
                                                        .searchiteams[result]["timestamp"].microsecondsSinceEpoch))
                                                    .toString(),
  ...
  Widget _buildMessageiteam(document, String email, String uid, String proPic, int legnth, var snapshot) {
    ...
    return apilist.contains(uid)
        ...
        : ListTile(
            ...
            subtitle: Text(data["message"], style: Theme.of(context).textTheme.bodySmall),
            trailing: Text(
                DateFormat('hh:mm a')
    ...
    if (Provider.of<HomeProvider>(context, listen: false).userlocalData.userLogin!.name != data["name"]) {
      return StreamBuilder(
          stream: chatservices.getMessage(
              userId: data["uid"], otherUserId: Provider.of<HomeProvider>(context, listen: false).uid),
          builder: (context, snapshot) {
            if (snapshot.hasError) {
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return snapshot.data!.docs.isEmpty
                  ? const SizedBox()
                  : _buildMessageiteam(snapshot.data!.docs.last, data["name"], data["uid"],
                      data["pro_pic"].toString(), legth, snapshot);
            }
          });
    } else {
      return const SizedBox();
    ...
    onDidReceiveNotificationResponse: (payload) async {
      ...
      if (data["vcId"] == "null" && data["Audio"] == "null") {
        navigatorKey.currentState?.push(MaterialPageRoute(
          builder: (context) =>
              ChattingPage(resiverUserId: data["id"], resiverUseremail: data["name"], proPic: data["propic"]),
        ));
