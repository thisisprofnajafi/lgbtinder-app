...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    homeProvider.animation =
        Tween<Offset>(begin: Offset.zero, end: const Offset(-1.0, -1.0)).animate(homeProvider.controller);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: BlocBuilder<HomePageCubit, HomePageStates>(builder: (context, state) {
                  ...
                  ? Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            AppLocalizations.of(context)?.translate("No New Profiles") ?? "No New Profiles",
                          ...
                          MainButton(
                            ...
                            title: AppLocalizations.of(context)?.translate("Change my preferences") ??
                      ...
                      children: [
                        PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            int nextIndex = homeProvider.currentIndex == state.homeData.profilelist!.length - 1
                                ? 0
                                : homeProvider.currentIndex + 1;
                            return index == state.homeData.profilelist!.length - 1
                                ? const SizedBox()
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: Stack(
                                            children: [
                                                                ...
                                                                children: [
                                                                  Stack(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      state.homeData.profilelist![nextIndex]
                                                                                  .isSubscribe !=
                                                                              "0"
                                                                          ? Row(
                                                                              children: [
                                              ...
                                              state.homeData.profilelist![nextIndex].profileImages!.length > 1
                                                  ? SizedBox(
                                                      height: 25,
                                                      width: MediaQuery.of(context).size.width,
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...List.generate(
                                                              state.homeData.profilelist![nextIndex].profileImages!
                                                                  .length, (index) {
                                                            return Indicator(
                                                              isActive:
                                                                  homeProvider.interIndex1 == index ? true : false,
                                                            );
                                                          }),
                                                        ],
                                                      ),
                                          ...
                                          child: Stack(
                                            children: [
                                              CarouselSlider.builder(
                                                itemCount: state.homeData.profilelist![homeProvider.currentIndex]
                                                ...
                                                options: CarouselOptions(
                                                    autoPlay: state
                                                                .homeData
                                                                .profilelist![homeProvider.currentIndex]
                                                                .profileImages!
                                                                .length >
                                                            1
                                                        ? true
                                              ...
                                              state.homeData.profilelist![homeProvider.currentIndex].profileImages!
                                                          .length >
                                                      1
                                                  ? SizedBox(
                                                      height: 25,
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...List.generate(
                                                            ...
                                                            return Indicator(
                                                              isActive:
                                                                  homeProvider.interIndex == index ? true : false,
                                                            );
                                                          }),
                                                        ],
                                                      ),
                                      ...
                                      itemBuilder: (c, i) {
                                        return Center(
                                          child: InkWell(
                                              ...
                                              if (state.homeData.profilelist!.isNotEmpty) {
                                                if (i == 0) {
                                                  ...
                                                  BlocProvider.of<HomePageCubit>(context).profileLikeDislikeApi(
                                                      ...
                                                      proId: state.homeData.profilelist![homeProvider.currentIndex]
                                                          .profileId!,
                                                      action: "UNLIKE",
                                            ...
                                            child: (i == 2 && state.homeData.planId != "0")
                                                ? (state.homeData.planId == "3")
                                                    ? InkWell(
                                                        ...
                                                        child: Container(
                                                          height:
                                                              (i == 0 || i == homeProvider.flotingIcons.length - 1)
                                                                  ? 60
                                                                  : 72,
                                                          width:
                                                              (i == 0 || i == homeProvider.flotingIcons.length - 1)
                                                    ...
                                                    : const SizedBox()
                                                : Container(
                                                    height: (i == 0 || i == homeProvider.flotingIcons.length - 1)
                                                        ? 60
                                                        : 72,
                                                    width: (i == 0 || i == homeProvider.flotingIcons.length - 1)
                                                        ? 60
                                                        : 72,
                                                    decoration: BoxDecoration(
                                                        color: AppColors.darkContainer,
