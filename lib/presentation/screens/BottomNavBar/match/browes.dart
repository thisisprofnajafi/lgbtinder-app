                        ...
                        Container(
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: NetworkImage("${Config.baseUrl}${data.profileImages!.first}"),
                                  fit: BoxFit.cover),
                              border: Border.all(color: AppColors.appColor, width: 4),
                              borderRadius: BorderRadius.circular(30),
                              color: AppColors.greyLight),
                        ),
                        SvgPicture.asset("assets/Image/Rectangle.svg",
                            fit: BoxFit.fitWidth,
                            colorFilter: ColorFilter.mode(AppColors.appColor.withOpacity(0.8), BlendMode.srcIn)),
                        Container(
                          height: 30,
                          width: 80,
                          decoration: BoxDecoration(
                          ...
                          child: Center(
                            child: RichText(
                              ...
                              TextSpan(
                                text: "${data.matchRatio.toString().split(".").first}% ",
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text("${data.profileName.toString()},${data.profileAge}",
                                ...
                                data.profileBio.toString().toUpperCase().isEmpty
                                    ...
                                    : Padding(
                                        padding: const EdgeInsets.symmetric(horizontal: 8.0),
                                        child: Text(data.profileBio.toString().toUpperCase(),
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall!
                                                .copyWith(color: Colors.white, wordSpacing: 2, fontSize: 12),
                                            maxLines: 2,
                ...
                return ClipRRect(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      var long = Provider.of<OnBordingProvider>(context, listen: false).long;
                      Provider.of<DetailProvider>(context, listen: false).updateIsMatch(true);
                      Provider.of<DetailProvider>(context, listen: false).status = "4";
                      Provider.of<DetailProvider>(context, listen: false)
                          .detailsApi(
                              uid: Provider.of<HomeProvider>(context, listen: false).uid ?? "",
                              lat: lat.toString(),
                ...
                return ClipRRect(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      var long = Provider.of<OnBordingProvider>(context, listen: false).long;
                      Provider.of<DetailProvider>(context, listen: false).updateIsMatch(true);
                      Provider.of<DetailProvider>(context, listen: false).status = "3";
                      Provider.of<DetailProvider>(context, listen: false)
                          .detailsApi(
                              uid: Provider.of<HomeProvider>(context, listen: false).uid ?? "",
                              lat: lat.toString(),
                ...
                return SizedBox(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      var long = Provider.of<OnBordingProvider>(context, listen: false).long;
                      Provider.of<DetailProvider>(context, listen: false).updateIsMatch(true);
                      Provider.of<DetailProvider>(context, listen: false).status = "2";
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("${data.profileName.toString()},${data.profileAge}",
                                                style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                                                    color: Colors.white,
                                            ...
                                            Text(data.profileBio.toString().toUpperCase(),
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .bodySmall!
                                                    .copyWith(color: Colors.white, wordSpacing: 2, fontSize: 12),
                                        ...
                                        onTap: () {
                                          BlocProvider.of<MatchCubit>(context)
                                              .profileLikeDislikeApi(
                                                  ...
                                                  // action: "UNLIKE".tr)
                                                  action: AppLocalizations.of(context)?.translate("UNLIKE") ??
                                                      "UNLIKE")
                                              .then((value) {
                                            matchProvider.callAllApi(context);
                                          });
                                        ...
                                        onTap: () {
                                          BlocProvider.of<MatchCubit>(context)
                                              .profileLikeDislikeApi(
                                                  ...
                                                  // action: "LIKE".tr)
                                                  action:
                                                      AppLocalizations.of(context)?.translate("LIKE") ?? "LIKE")
                                              .then((value) {
                                            if (value == "true") {
                                              matchProvider.callAllApi(context);
                                              ...
                                              Provider.of<LikeMatchProvider>(context, listen: false)
                                                  .likeMatchData
                                                  .add(data);
                                              Navigator.pushNamed(context, LikeMatchScreen.likeMatchScreenRoute);
                                            }
                                          });
                                        },
                                        child: Container(
