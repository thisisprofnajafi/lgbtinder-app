...
class PaymentCardCreated {
  ...
  PaymentCardCreated(
      {this.type, this.number, this.name, this.amount, this.month, this.year, this.cvv, this.email,this.userId,this.planId});

  @override
  String toString() {
    return '[Type: $type, Number: $number, Name: $name, Month: $month, Year: $year, CVV: $cvv, Email: $email, Amount: $amount, UserId: $userId, PlanId: $planId]';
  }
}

enum CardTypee { Master, Visa, Verve, Discover, AmericanExpress, DinersClub, Jcb, Others, Invalid }
