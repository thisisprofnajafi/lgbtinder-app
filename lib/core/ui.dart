...
class AppColors {
  static Color appColor = const Color(0xffBF100F);
  static Color appBgColorlite = const Color(0xffffffff);
  static Color appBgColordart = const Color(0xff10100b);
  static Color textLight = const Color(0xff880707);
  static Color text1Light = const Color(0xffFB6663);
  ...
  static Color black = const Color(0xff5A0404);
  ...
  static ThemeData defaultTheme = ThemeData(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      ...
      shape: RoundedRectangleBorder(
          side: BorderSide(color: AppColors.borderColor), borderRadius: BorderRadius.circular(12)),
...
class TextStyles {
  static TextStyle heading1 = TextStyle(
      fontWeight: FontWeight.bold, color: AppColors.textLight, fontSize: 70, fontFamily: FontFamilyy.bold);

  static TextStyle heading2 = TextStyle(
      fontWeight: FontWeight.bold, color: AppColors.textLight, fontSize: 32, fontFamily: FontFamilyy.bold);

  static TextStyle heading3 = TextStyle(
      fontWeight: FontWeight.bold, fontSize: 24, color: AppColors.textLight, fontFamily: FontFamilyy.bold);

  static TextStyle body1 = TextStyle(
      fontWeight: FontWeight.normal, fontSize: 18, color: AppColors.textLight, fontFamily: FontFamilyy.medium);

  static TextStyle body2 = TextStyle(
      fontWeight: FontWeight.normal, fontSize: 16, color: AppColors.textLight, fontFamily: FontFamilyy.medium);

  static TextStyle body3 = TextStyle(
      fontWeight: FontWeight.w500, fontSize: 14, color: AppColors.textLight, fontFamily: FontFamilyy.medium);

  static TextStyle title1 = TextStyle(
      fontWeight: FontWeight.w300, fontSize: 12, color: AppColors.borderColor, fontFamily: FontFamilyy.regular);

  static TextStyle title2 = TextStyle(
      fontWeight: FontWeight.w300, fontSize: 10, color: AppColors.borderColor, fontFamily: FontFamilyy.regular);

  static TextStyle buttonTextStyle = TextStyle(
      fontWeight: FontWeight.w700, fontSize: 16, color: AppColors.textLight, fontFamily: FontFamilyy.medium);
}
